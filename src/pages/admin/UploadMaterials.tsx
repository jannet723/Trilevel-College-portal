        ...
        <nav className="flex-1 p-4">
          ...
          <ul className="space-y-1.5">
            {[
              ...
              { icon: <UsersIcon size={18} />, label: "Students", path: "/admin/students" },
              { icon: <BookOpen size={18} />, label: "Courses", path: "/admin/courses" },
              { icon: <Upload size={18} />, label: "Upload", path: "/admin/upload", active: true },
            ].map((item, idx) => (
              <li key={idx}>
                <button
          ...
          <ul className="space-y-1.5">
            {[
              { icon: <CalendarIcon size={18} />, label: "Schedule", path: "/admin/schedule" },
              { icon: <AwardIcon size={18} />, label: "Analytics", path: "/admin/analytics" },
            ...
            <div className="space-y-6">
              <div className="bg-white/80 backdrop-blur-sm rounded-xl border border-[#e8e2d9] p-5">
                <div className="flex items-center gap-2 mb-4">
                  <div className="w-8 h-8 rounded-lg bg-linear-to-br from-[#e8f0fe] to-[#d4e2f7] flex items-center justify-center">
                    <SettingsIcon size={14} className="text-[#4a6a9b]" />
                  </div>
