...
const AdminPageHeader = ({
  ...
  return (
    <header className="portal-page-header mb-6">
      ...
      <div className="md:hidden flex items-center justify-between px-0 py-4 mb-4 -mx-5 px-5 border-b border-[#e8e2d9] bg-white sticky top-0 z-20">
        <img
          src="/logo.png"
      ...
      <div className="flex items-center justify-between gap-2 mb-4 flex-wrap">
        <nav className="flex items-center gap-2 text-xs text-[#9b9288]">
          <button
            type="button"
